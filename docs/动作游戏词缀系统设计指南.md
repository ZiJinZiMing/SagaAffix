# 动作游戏词缀系统设计指南 / Action Game Affix System Design Guide

## 文档信息 / Document Information
- **文档标题 / Document Title**: 动作游戏词缀系统设计指南 / Action Game Affix System Design Guide
- **创建日期 / Creation Date**: 2025-07-17
- **版本 / Version**: v1.0
- **文档作者 / Document Author**: JM
- **用途 / Purpose**: 为动作游戏开发者提供词缀系统设计的全面指导 / Provide comprehensive guidance for action game developers on affix system design
...
## 引言：化学反应的开始 / Introduction: The Beginning of Chemical Reactions

当动作游戏遇见词缀系统，产生的不是简单的功能叠加，而是**游戏设计DNA的重组**。这种结合创造了从"掌握"到"创造"的范式转变，让每个玩家都能成为游戏世界中的"设计师"。

### 核心价值公式 / Core Value Formula
```
...
## 核心玩法的化学反应 / Chemical Reactions in Core Gameplay
