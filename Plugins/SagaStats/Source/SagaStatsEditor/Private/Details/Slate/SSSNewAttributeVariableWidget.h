 ...
 */
class SSSNewAttributeVariableWidget : public SCompoundWidget
{
public:

	DECLARE_DELEGATE_OneParam(FOnWindowClosed, const TSharedPtr<FSSNewAttributeViewModel>&);
	
	SLATE_BEGIN_ARGS(SSSNewAttributeVariableWidget) {}
	...
	void Construct(const FArguments& InArgs, const TSharedPtr<FSSNewAttributeViewModel>& InViewModel);
...
private:
	...
	TSharedPtr<FSSNewAttributeViewModel> ViewModel;
