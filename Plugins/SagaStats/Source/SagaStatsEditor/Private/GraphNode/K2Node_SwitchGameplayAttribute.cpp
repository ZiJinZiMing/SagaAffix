	...
	: Super(ObjectInitializer)
{
	...
	FunctionClass = USGBlueprintLibrary::StaticClass();
...
FName UK2Node_SwitchGameplayAttribute::GetPinNameGivenIndex(const int32 Index) const
{
	check(Index);
...
bool UK2Node_SwitchGameplayAttribute::IsGasCompanionPluginEnabled()
{
