 ...
 */
class FSagaAttributeSetBlueprintEditor : public FBlueprintEditor
{
public:
	FSagaAttributeSetBlueprintEditor();
	virtual ~FSagaAttributeSetBlueprintEditor() override;
...
private:
	...
	void HandleAttributeWindowFinish(const TSharedPtr<FSSNewAttributeViewModel>& InViewModel);
