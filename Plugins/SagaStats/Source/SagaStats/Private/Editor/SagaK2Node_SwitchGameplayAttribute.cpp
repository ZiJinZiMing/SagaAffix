	...
	: Super(ObjectInitializer)
{
	...
	FunctionClass = USagaBlueprintLibrary::StaticClass();
	OrphanedPinSaveMode = ESaveOrphanPinMode::SaveNone;
}

void USagaK2Node_SwitchGameplayAttribute::CreateFunctionPin()
{
...
void USagaK2Node_SwitchGameplayAttribute::PostLoad()
{
	Super::PostLoad();
...
void USagaK2Node_SwitchGameplayAttribute::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	bool bIsDirty = false;
	const FName PropertyName = PropertyChangedEvent.Property ? PropertyChangedEvent.Property->GetFName() : NAME_None;
	if (PropertyName == GET_MEMBER_NAME_CHECKED(USagaK2Node_SwitchGameplayAttribute, PinAttributes) || PropertyName == FName("AttributeName"))
	{
		bIsDirty = true;
	}
...
FText USagaK2Node_SwitchGameplayAttribute::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return NSLOCTEXT("K2Node", "SagaK2Node_Switch_GameplayAttribute", "Switch on Gameplay Attribute");
}

FText USagaK2Node_SwitchGameplayAttribute::GetTooltipText() const
{
...
void USagaK2Node_SwitchGameplayAttribute::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void USagaK2Node_SwitchGameplayAttribute::CreateSelectionPin()
{
...
FEdGraphPinType USagaK2Node_SwitchGameplayAttribute::GetPinType() const
{
...
FEdGraphPinType USagaK2Node_SwitchGameplayAttribute::GetInnerCaseType() const
{
	// This type should match the second argument of USagaBlueprintLibrary::NotEqual_GameplayAttributeGameplayAttribute !
	FEdGraphPinType PinType;
	PinType.PinCategory = UEdGraphSchema_K2::PC_String;
	return PinType;
}

FName USagaK2Node_SwitchGameplayAttribute::GetPinNameGivenIndex(const int32 Index) const
{
	check(Index);
	return PinNames[Index];
}

void USagaK2Node_SwitchGameplayAttribute::CreateCasePins()
{
...
FName USagaK2Node_SwitchGameplayAttribute::GetUniquePinName()
{
	FName NewPinName;
	int32 Index = 0;
	while (true)
...
void USagaK2Node_SwitchGameplayAttribute::AddPinToSwitchNode()
{
	const FName PinName = GetUniquePinName();
	PinNames.Add(PinName);
...
void USagaK2Node_SwitchGameplayAttribute::RemovePin(UEdGraphPin* TargetPin)
{
	checkSlow(TargetPin);
...
bool USagaK2Node_SwitchGameplayAttribute::IsGasCompanionPluginEnabled()
{
